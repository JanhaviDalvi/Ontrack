...
window.onload = function () {
	...
	var habitButton = document.getElementById("mark_done");
	var streak = document.getElementById("streak_value");
	var habitStreak = parseInt(streak.textContent)	;
	console.log(habitStreak);
	// var habitStreak = Number(streak.innerHTML);
	// console.log(habitStreak);
	// function for habitButton
	habitButton.addEventListener("click", function () {
		// get the current date
